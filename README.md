...
## О проекте
Mega Kazino — мобильное Android-приложение, созданное в рамках командного учебного проекта.  
Сейчас проект представляет собой базовое приложение с одним экраном и настроенной инфраструктурой для дальнейшей разработки.
...
Приложение Mega Kazino — это Android-приложение с базовым пользовательским интерфейсом, которое будет развиваться в рамках следующих этапов проекта.
